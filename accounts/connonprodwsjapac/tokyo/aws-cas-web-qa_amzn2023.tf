resource "aws_instance" "cas_web_amzn2003" {
  ...
  vpc_security_group_ids = [data.aws_security_group.b_selected["wsjapac-default-sg"].id, data.aws_security_group.b_selected["djif_infrastructure_tools"].id, aws_security_group.cas_web-sg.id]
