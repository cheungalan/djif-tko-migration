resource "aws_instance" "aws_cas_web_amzn2003" {
  ...
  vpc_security_group_ids = [data.aws_security_group.b_selected["wsjapac-default-sg"].id, data.aws_security_group.b_selected["djif_infrastructure_tools"].id, aws_security_group.aws_cas_web_sg.id]
